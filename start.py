...
def check_env_file():
    ...
    if not os.path.exists(".env"):
        print("⚠️  Fichier .env manquant. Crée un fichier .env avec les variables DATABASE_URL et API_TOKEN.")
        print("Exemple de contenu pour .env :")
        print("DATABASE_URL=postgresql://postgres:MSPR4_Commandes@db.kmchiernfkyehxovldwa.supabase.co:5432/postgres")
